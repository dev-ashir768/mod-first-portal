    ...
    <div className="flex gap-2 justify-center">
      {Array.from({ length: 6 }).map((_, i) => (
        <input
          ...
          onPaste={handlePaste}
          className="h-11 w-10 rounded-lg border border-input bg-white text-center text-lg font-bold text-foreground outline-none transition-all focus:border-ring focus:ring-2 focus:ring-ring/30 dark:bg-input/30"
        />
      ))}
    </div>
  );
